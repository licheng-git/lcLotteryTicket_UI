//
//  BettingRecordsViewController.swift
//  LotteryTicket
//
...
class BettingRecordsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    
    let vm = BettingRecords_ViewModel()
    ...
    lazy var myTableview: UITableView = {
        ...
        tableview.register(BettingRecords_TableCell.classForCoder(), forCellReuseIdentifier: "CellId")
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        return BettingRecords_TableCell.brHeight
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId", for: indexPath) as! BettingRecords_TableCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc = BettingDetailViewController(nibName: "BettingDetailViewController", bundle: Bundle.main)
